...
<body class="img js-fullheight" style="background-image: url(images/gunung.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">From Registrasi Aplikasi Pengaduan Masyarakat</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						<form action="/masyarakat/daftar" method="POST" class="signup-form">
							...
							<div class="form-group">
								<input name="txtTelp" type="text" class="form-control" placeholder="Nomor Telphone" required>
							</div>
